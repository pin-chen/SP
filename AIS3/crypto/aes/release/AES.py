    ...
    for _ in range(5):
        try:
            ...
            if mode == "CFB":
                ...
                print("A:", AES_enc(counter) )
                print("A:", AES_enc(counter_add(counter)) )
                print("A:", AES_enc(counter_add(counter_add(counter))) )
                print("A:", AES_enc(counter_add(counter_add(counter_add(counter)))) )
                print("A:", AES_enc(counter_add(counter_add(counter_add(counter_add(counter))))) )
            else:
