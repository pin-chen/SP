...
def count_set_bits(D):
    binary_str = bin(D)  # Convert the integer to binary representation
    bit_count = binary_str.count('1')  # Count the number of '1' bits
    return bit_count
